"""
Django settings for workshop_admin project.
...
SECRET_KEY = 'q@a4ig#-4uv22nn2p(t-+$uh_(0@ok9x8qa(sni+_o91zx)859'
...
ROOT_URLCONF = 'workshop_admin.urls'
...
WSGI_APPLICATION = 'workshop_admin.wsgi.application'
...
AUTH_USER_MODEL = 'moodle.MoodleUser'

AUTHENTICATION_BACKENDS = (
    'main.middleware.MoodleAccountAuthorization',
)
